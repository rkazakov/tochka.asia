...
<?php $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'recent_post_thumb'); ?>
...
<div class="clear"></div>
 	...
 	<div class="info">
 	<p class="entry-title"><a title="<?php the_title(); ?>" href="<?php the_permalink() ?>"><?php //the_title(); ?> <?php echo excerpt(10);?></a></p>
	<div class="meta">
    <?php the_time('F d, Y'); ?> <span>-</span><b><?php comments_number('0','1','%'); ?></b> Комментариев
	</div> <!--end .entry-meta--> 	
	</div> <!--end .info-->
	<div class="clear"></div>
</li>
