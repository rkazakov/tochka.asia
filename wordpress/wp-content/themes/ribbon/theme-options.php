...
$args['opt_name'] = 'ribbon';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('Ribbon', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Ribbon', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(Recommended size 188x70px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
